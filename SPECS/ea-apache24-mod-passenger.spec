...
# this actually defines a dependency, I am correcting the name
...
# rerun rake to make sure the code our patches applied are used
rm -f src/apache2_module/ConfigGeneral/AutoGeneratedDefinitions.cpp || /bin/true
rake src/apache2_module/ConfigGeneral/AutoGeneratedDefinitions.cpp || /bin/true
